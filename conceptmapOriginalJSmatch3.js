...
console.log("id",id);
  ...
  String.prototype.contains = function(it) { return this.indexOf(it) != -1; };
    ...
    function drawDetails() {
        ...
        mouseoutNode();
        fillColor();
		d3.selectAll("#nodeDepthOneMain").selectAll("circle")
		.attr("fill",function(nodes) { return (nodes.type =='theme')?
			highlightColor:(nodes.type =='perspective')? '#fff':highlight;})
		.attr('stroke',function(nodes) {return (nodes.type =='episode')?
			'#ffa500':'#000';});
    }
